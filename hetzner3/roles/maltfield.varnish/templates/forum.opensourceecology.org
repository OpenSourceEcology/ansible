...
################################################################################
# File:    forum.opensourceecology.org.vcl
# Version: 0.3
...
backend forum_opensourceecology_org {
	.host = "127.0.0.1";
	.port = "8000";
}
...
sub vcl_recv {
	...
	if ( req.http.host == "forum.opensourceecology.org" ){

		# define which backend (apache) to use
		set req.backend_hint = forum_opensourceecology_org;

		# Tell PageSpeed not to make browser-specific optimizations
		...
		include "../conf/purge-key_forum.opensourceecology.org.vcl"
...
sub vcl_backend_response {
	...
	if ( beresp.backend.name == "forum_opensourceecology_org" ){
