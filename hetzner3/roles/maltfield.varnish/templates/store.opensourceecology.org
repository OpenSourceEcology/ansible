...
################################################################################
# File:    store.opensourceecology.org.vcl
# Version: 0.3
...
backend store_opensourceecology_org {
	.host = "127.0.0.1";
	.port = "8000";
}
...
sub vcl_recv {
	...
	if ( req.http.host == "store.opensourceecology.org" ){

		# define which backend (apache) to use
		set req.backend_hint = store_opensourceecology_org;
		...
		include "../conf/purge-key_store.opensourceecology.org.vcl"
...
sub vcl_backend_response {
	...
	if ( beresp.backend.name == "store_opensourceecology_org" ){
