################################################################################
# File:    www.openbuildinginstitute.org.vcl
# Version: 0.3
...
backend www_openbuildinginstitute_org {
	.host = "127.0.0.1";
	.port = "8000";
}
...
sub vcl_recv {
	...
	if ( req.http.host == "www.openbuildinginstitute.org" ){

		# define which backend (apache) to use
		set req.backend_hint = www_openbuildinginstitute_org;
		...
		include "../conf/purge-key_www.openbuildinginstitute.org.vcl"
...
sub vcl_backend_response {
	...
	if ( beresp.backend.name == "www_openbuildinginstitute_org" ){
